...
const StarshipsScreen = ({ resourceDetail, FetchResourceDatail }) => {
    ...
    const ListHeaderComponent = () => {
        return (
            <View>
                ...
                <Text style={styles.textStyle}>Hyperdrive Rating: {resourceDetail.hyperdrive_rating}</Text>
                <Text style={styles.textStyle}>MGLT: {resourceDetail.MGLT}</Text>
                <Text style={styles.textStyle}>Starship Class: {resourceDetail.starship_class}</Text>
...
export default connect(mapStateToProps, { FetchResourceDatail })(StarshipsScreen);